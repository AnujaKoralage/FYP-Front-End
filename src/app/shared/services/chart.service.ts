...
import {CurrencyPair} from '../enum/currency-pair.enum';
...
// Create chart instance
    const chart = am4core.create('depthchart', am4charts.XYChart);

// Add data
    chart.dataSource.url = 'https://poloniex.com/public?command=returnOrderBook&currencyPair=' + currencyPair + '&depth=50';
